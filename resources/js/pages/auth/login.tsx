...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    return (
        <AuthLayout title="Log in" description="">
            <Head title="Log in" />
                ...
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center">
                            <Label htmlFor="password" className="text-sm font-medium text-white block">Password</Label>
                            {canResetPassword && (                                <TextLink href={route('password.request')} className="ml-auto text-sm text-white" tabIndex={5}>
                                    Forgot password?
                    ...
                    <Button type="submit" className="w-full py-2 bg-red-600 text-white font-semibold rounded-md
							hover:bg-red-700" tabIndex={4} disabled={processing}>
